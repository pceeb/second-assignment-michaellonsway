...
```
  ...
  c. The first three lines and the last two lines of animals.txt This answer corresponds to the file
...
6. In the example below, what does cp do when given three or more file names? It will give an error because a directory isn't listed
```
$ ls -F
```
