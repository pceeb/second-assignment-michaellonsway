...
```
 ...
 Use 'ls -l' to inspect the files. How large is my_file.txt? The file is 0 bytes
...
```
What is the difference between > and >> ? Using > will overwrite information and using >> will not overwrite and will place new information
